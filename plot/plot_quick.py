...
class plot_from_ds:
    ...
    def variable_len(self, *arr_to_plot, opacity,
        ...
        for i in range(len(self.datasets_x)):
            ...
            if 'virial_length' in arr_to_plot[0] and len(arr_to_plot[0])==1:
                self.ax.set_ylabel(labels[7])
...
#TODO Opacity as input
    ...
    def variable_height(self, *arr_to_plot, opacity,
                legend=None, lab_lines=None, draw_vlines=None,
    ...
    def variable_time(self, *arr_to_plot, opacity=1, draw_inset=None,
