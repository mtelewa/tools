...
import sys
import argparse
import grid_conv_div_walls as grid
...
def get_parser():
    ...
    parser.add_argument('beginConvergeX', metavar='beginConvergeX', action='store', type=float,
                    help='Multiple of Lx, where the narrow region starts')
    parser.add_argument('endConvergeX', metavar='endConvergeX', action='store', type=float,
                    help='Multiple of Lx, where the narrow region ends')
    parser.add_argument('beginDivergeX', metavar='beginDivergeX', action='store', type=float,
                    help='Multiple of Lx, where the wide region starts')
    parser.add_argument('endDivergeX', metavar='endDivergeX', action='store', type=float,
                    help='Multiple of Lx, where the wide region ends')
...
if __name__ == "__main__":
    ...
    grid.make_grid(args.infile, args.Nx, args.Ny, args.Nz, args.slice_size, mf, A_per_molecule, args.fluid,
                    ...
                    args.beginConvergeX, args.endConvergeX, args.beginDivergeX, args.endDivergeX, args.tessellate, args.TW_interface)
