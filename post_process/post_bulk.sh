...
mpirun -np 8 proc_bulk.py $infile.nc $Nchunks 1 1000 $fluid --Ny $Ny --tessellate $tessellate
mpirun -np 8 proc_bulk.py $infile.nc 1 $Nchunks 1000 $fluid --Ny $Ny --tessellate $tessellate
