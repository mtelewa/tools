...
def proc(infile, Nx, Nz, slice_size, Ny=1):
    ...
    for slice in range(Nslices):
        ...
        comm.Gatherv(sendbuf=surfL_end, recvbuf=(surfL_end_global, sendcounts_time), root=0)
        ...
        if rank == 0:
            ...
            surfL_end_var =  out.createVariable('SurfL_end', 'f4',  ('step'))
            ...
            surfL_end_var[:] = surfL_end_global
