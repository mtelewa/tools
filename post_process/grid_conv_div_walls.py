...
import netCDF4
import processor_conv_div_walls as pnc
...
def make_grid(infile, Nx, Ny, Nz, slice_size, mf, A_per_molecule, fluid, stable_start,
                        stable_end, pump_start, pump_end, beginConvergeX, endConvergeX, beginDivergeX, endDivergeX,
                        tessellate, TW_interface):
    """
    Parameters:
    -----------
    ...
    beginConvergeX, endConvergeX, beginDivergeX, endDivergeX: bounds of narrow and wide regions
